...
public class CommandPaletteWindow : EditorWindow {
    ...
    private const float MinHeight = 128.0f;
    ...
    private static void ShowWindow() {
        var windows = Resources.FindObjectsOfTypeAll<CommandPaletteWindow>();
        ...
        window.minSize = new Vector2(BaseWidth, 0);
        window.position = new Rect(s_UnityEditorWindowPosition.x + 0.5f * s_UnityEditorWindowSize.x - 0.5f * BaseWidth, s_UnityEditorWindowPosition.y + YOffset, BaseWidth, MinHeight);
    ...
    private static void InitializeBackground() {
        ...
        var screen = InternalEditorUtility.ReadScreenPixel(s_UnityEditorWindowPosition, s_UnityEditorWindowSize.x, s_UnityEditorWindowSize.y);
    ...
    public void SetHeight(float height) {
        position = new Rect(s_UnityEditorWindowPosition.x + 0.5f * s_UnityEditorWindowSize.x - 0.5f * BaseWidth, s_UnityEditorWindowPosition.y + YOffset, BaseWidth, Mathf.Max(height, MinHeight));
    }
